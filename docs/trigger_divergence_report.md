...
The committed cache is 76 MB covering 136 API responses. **All thermal data comes from the FortyGuard Temperature API; no external weather or temperature service is used anywhere in the pipeline.**
